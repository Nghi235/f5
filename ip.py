...
driver.find_element_by_xpath('/html/body/div[2]/section/div/div/div/div/div[4]/form/div[1]/input').send_keys('taikhoan02')
driver.find_element_by_xpath('/html/body/div[2]/section/div/div/div/div/div[4]/form/div[2]/input').send_keys('taikhoan02')
